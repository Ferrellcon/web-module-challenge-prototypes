...
Car.prototype.drive = function(dist){
  const driveableMiles = tid.tank * this.milesPerGallon;
...
/* 
  ...
  1. Window Binding -  will return the window or global object in node or undefined in strict mode
  2. Implicit binding - when you invoke a function this refers to what is to the left of the dot
  3. Explicit binding - .call .apply .bind
  4. new binding - when a constructor is created, this points to the newly created object
*/
